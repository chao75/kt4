...
public class dijkstra {
    public static Namespace getArgs(String[] args, Logger logger) {
        ArgumentParser argumentParser = ArgumentParsers.newFor("aStar").build()
                .description("Calculate shortest path between tow points in road network employing dijkstra algorithm.");
    ...
    public static void main(String[] args) throws Exception {
        Logger logger = Logging.getLogger("dijkstra.log");
        ...
        IShortPathAlgorithm aStarAlg = ShortPathFactory.createShortPathFunction("dijkstra");
